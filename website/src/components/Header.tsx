      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <Link
              href="/blog"
              className="text-white/90 hover:text-[#cda540] transition-colors font-medium text-sm"
            >
              Blog
            </Link>
            <Link
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a
              ...
              className="text-white/60 hover:text-[#cda540] transition-colors"
      ...
      {menuOpen && (
        <div className="lg:hidden bg-[#1a0a1e] border-t border-white/10">
          <nav className="px-4 py-4 flex flex-col gap-1">
            <div className="py-2">
              <button
                className="flex items-center gap-2 text-white/80 font-medium text-base w-full"
            ...
            <Link
              href="/blog"
              className="py-2 text-white/80 hover:text-[#cda540] transition-colors font-medium"
              onClick={() => setMenuOpen(false)}
            >
              Blog
            </Link>
            ...
            <div className="pt-2">
              <CalendlyButton variant="primary" size="md" className="w-full">
                Réserver un diagnostic
              </CalendlyButton>
            </div>
          </nav>
