...
export default function NeurosciencesManagersPage() {
  return (
    <>
      {/* ── HERO ──────────────────────────────────────────── */}
      <section
        className="relative min-h-[65vh] flex items-center overflow-hidden pt-24 pb-20"
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SectionReveal>
            ...
            >
              Neurosciences{" "}
              <span style={{ color: "#cda540" }}>pour Managers</span>
            </h1>
            <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
              24h de formation en ligne · 18h d&apos;accompagnement individuel · 3 mois
            </p>
            <p className="text-white/60 max-w-xl mx-auto mb-10 leading-relaxed">
              Comprendre et gérer les comportements difficiles et toxiques à la
              lumière des neurosciences. Un programme complet pour managers en
              activité, 100&nbsp;% à distance.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <SectionReveal direction="left">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "#cda540" }}
                >
                  24h · 8 modules · 54 capsules vidéo (~10 min)
                </p>
                <p className="text-gray-600 leading-relaxed mb-5 text-sm">
                  Un contenu structuré, progressif, accessible à vie avec tous
                  les ajouts en temps réel inclus. Chaque module inclut des
                  exercices pratiques et des auto-diagnostics directement
                  applicables en situation managériale réelle.
                </p>
                <ul className="space-y-2">
                  {[
                    "Accès illimité à vie",
                    "Tous les ajouts en temps réel inclus",
                    "Progressez à votre rythme, depuis n'importe où",
                  ].map((item) => (
            ...
            <SectionReveal direction="right">
              ...
              >
                <div
                  className="w-12 h-12 rounded-full flex items-center justify-center mb-5"
                  style={{ backgroundColor: "#cda540", color: "white" }}
                >
                  <Users size={22} />
                </div>
                <h3
                ...
                <p
                  ...
                  style={{ color: "#78427f" }}
                >
                  1h30 / semaine · 3 mois · 18h au total · Zoom
                </p>
                <p className="text-gray-600 leading-relaxed mb-5 text-sm">
                  Chaque séance s&apos;articule autour de vos situations
                  professionnelles réelles de la semaine, des modules en cours
                  et de vos objectifs personnalisés définis en début de
                  parcours.
                </p>
                <ul className="space-y-2">
                  {[
                    "Travail sur vos situations réelles",
                    "Progression personnalisée à votre rythme",
                    "Plan d'action 30/60/90 jours",
                    "Suivi de la transformation sur 3 mois",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-2">
                      <CheckCircle
                        size={15}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {[
              {
                num: "01",
                title: "Qualifier avec précision",
                body: "Distinguer une situation de comportement difficile ou toxique à partir de faits observables, en utilisant les 3 critères clés : impact, persistance, conscience.",
              },
              {
                num: "02",
                title: "Expliquer les mécanismes",
                body: "Comprendre les mécanismes neuro-émotionnels impliqués dans les comportements toxiques et leurs effets sur l'équipe et sur vous-même.",
              },
              {
                num: "03",
                title: "Utiliser une boîte à outils",
                body: "Maîtriser grilles de lecture, trames d'entretien et protocoles de régulation directement opérationnels en situation réelle.",
              },
              {
                num: "04",
                title: "Adopter une posture régulée",
                body: "Développer une posture managériale plus ferme et protectrice pour l'équipe, ancrée dans la stabilité de votre système nerveux.",
              },
              {
                num: "05",
                title: "Déployer un plan d'action",
                body: "Construire et mettre en œuvre un plan d'action personnel à 30/60/90 jours sur vos propres cas managériaux.",
              },
            ].map((obj, i) => (
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionReveal className="text-center mb-12">
            ...
            <p className="text-white/50 mt-3 text-sm">
              54 capsules vidéo · ~10 min chacune · Accès illimité à vie
            </p>
          </SectionReveal>
              ...
              <SectionReveal key={mod.number} delay={i * 0.06}>
                <div
                  ...
                  style={{
                    ...
                    border: `1px solid ${mod.color === "#cda540" ? "rgba(205,165,64,0.3)" : "rgba(120,66,127,0.2)"}`,
                  }}
                >
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <h3
                      ...
                      style={{ color: mod.color === "#cda540" ? "#cda540" : "white" }}
                    >
                      {mod.title}
                    </h3>
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionReveal className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 text-sm max-w-xl mx-auto">
              1h30 par semaine en distanciel via Zoom — 18h d&apos;accompagnement
              personnalisé sur vos situations réelles
            </p>
          </SectionReveal>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <SectionReveal direction="left">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Cadres, Dirigeants et Managers en activité qui souhaitent
                  comprendre et gérer les comportements difficiles ou toxiques
                  par les outils des neurosciences.
                </p>
              </div>
            </SectionReveal>
            ...
            <SectionReveal direction="right">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Aucun prérequis nécessaire. Une expérience en management
                  d&apos;équipe est recommandée pour tirer pleinement profit du
                  programme.
                </p>
              </div>
            </SectionReveal>
      ...
      <section className="bg-white py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                label: "Dates",
                value: "À définir selon vos disponibilités",
              },
              {
                icon: <Clock size={20} />,
                label: "Durée totale",
                value: "24h formation + 18h accompagnement",
              },
              {
                icon: <MapPin size={20} />,
                label: "Format",
                value: "100 % distanciel via Zoom",
              },
              {
                icon: <Zap size={20} />,
                label: "Accès formation",
                value: "Illimité à vie, mises à jour incluses",
              },
            ].map((item, i) => (
              <SectionReveal key={i} delay={i * 0.07}>
                <div
                  ...
                  style={{
                    background: "rgba(120,66,127,0.03)",
                    border: "1px solid rgba(120,66,127,0.1)",
                  }}
                >
                  <div
                    className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-3"
                    style={{ backgroundColor: "rgba(120,66,127,0.1)", color: "#78427f" }}
                  >
                    {item.icon}
                  </div>
                  <p
          ...
          <SectionReveal className="mt-8">
            <div
              className="rounded-xl p-5 text-sm text-gray-500"
              style={{
                background: "rgba(120,66,127,0.02)",
                border: "1px solid rgba(120,66,127,0.08)",
              }}
            >
              <p className="mb-1">
                <span className="font-semibold text-gray-700">Délai d&apos;accès :</span>{" "}
                Le bénéficiaire doit retourner tous les documents signés 5 jours
                avant le début de la formation.
              </p>
              <p>
                <span className="font-semibold text-gray-700">Accessibilité :</span>{" "}
                Pour toute situation de handicap, merci de nous contacter.
                Aménagements au cas par cas : tiers-temps, adaptation des
                modalités.
              </p>
            </div>
          </SectionReveal>
      ...
      <section style={{ backgroundColor: "#1a0a1e" }} className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SectionReveal>
            ...
            <div
              className="inline-block rounded-2xl px-10 py-6 mb-8"
              style={{
                border: "2px solid #cda540",
                background: "rgba(205,165,64,0.05)",
              }}
            >
            ...
            <p className="text-white/60 mb-8 max-w-xl mx-auto">
              Un entretien découverte pour comprendre votre contexte, identifier
              ce qui bloque et co-construire le parcours le plus adapté.
            </p>
            ...
            <p className="text-white/40 text-xs mt-3">
              Sarah Dabancens · 06 43 45 51 45 · contact@sd-equicoaching.com
            </p>
          </SectionReveal>
        </div>
      </section>
